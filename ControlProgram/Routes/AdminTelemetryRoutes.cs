    ...
    private static object BuildPerformanceSnapshot(SimulationState state)
    {
        ...
        return new
        {
            ...
            transport = new
            {
                ...
                engramsCaptured = transport.EngramsCaptured,
                spontaneousGenerated = transport.SpontaneousGenerated,
                spontaneousDelivered = transport.SpontaneousDelivered,
                engramReplayGenerated = transport.EngramReplayGenerated,
                engramReplayDelivered = transport.EngramReplayDelivered,
                ...
                sleepReplaySelected = transport.SleepReplaySelected,
                sleepReplayDeliveryRatio = transport.SleepReplayDeliveryRatio,
