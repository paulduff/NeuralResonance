...
public partial class MainWindow : Window
{
    ...
    private const int FramePollMaxDispatchSpikes = 2048;
    private const int FrameStreamMaxOutputLog = 24;
    private const int FrameStreamMaxSpikeLog = 24;
    private const int FrameStreamMaxDispatchSpikes = 2048;
    ...
    private const int MaxNeuronHighlightsPerStructurePerFrame = 1536;
