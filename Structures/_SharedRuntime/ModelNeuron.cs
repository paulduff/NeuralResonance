		...
		double TonicDriveScale)
	{
		public static NeuronSubtypeProfile For(StructureCircuitProfile circuitProfile, int index)
		{
			return circuitProfile.StructureId switch
			{
				...
				StructureId.Snc or StructureId.Vta or StructureId.LocusCoeruleus or StructureId.RapheNuclei or StructureId.BasalForebrain => new NeuronSubtypeProfile(-63.0, 72.0, 1.35, 0.056, 2.5, 0.82, 520.0, 2.4, 0.72, 1.35, 1.1, 1.1, 0.76),
