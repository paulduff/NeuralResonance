...
@{Folder='BrocaBa44Ba45'; Enum='BrocaBa44Ba45'; Model='Izhikevich'; Plasticity='DopamineModulatedSTDP+SynapticTaggingCapture'; Just='Inferior frontal BA44/45 sequencing and articulatory planning require persistent excitatory activity and dopamine-sensitive gating.'; FeedbackMin=5; FeedbackMax=12},
@{Folder='WernickePstgPsts'; Enum='WernickePstgPsts'; Model='Izhikevich'; Plasticity='STDP+SynapticTaggingCapture'; Just='Posterior superior temporal language areas support phonological-lexical decoding with recurrent cortical dynamics and consolidation.'; FeedbackMin=3; FeedbackMax=8},
@{Folder='ArcuateFasciculus'; Enum='ArcuateFasciculus'; Model='LIF'; Plasticity='STDP'; Just='Arcuate fasciculus acts as a temporally constrained dorsal relay between temporal comprehension and frontal production circuits.'; FeedbackMin=2; FeedbackMax=6},
@{Folder='SupramarginalAngular'; Enum='SupramarginalAngular'; Model='Izhikevich'; Plasticity='STDP+SynapticTaggingCapture'; Just='Supramarginal/angular gyri integrate phonology, orthography, and multimodal semantic context during language comprehension.'; FeedbackMin=4; FeedbackMax=10},
...
@{Folder='NucleusBasalis'; Enum='NucleusBasalis'; Model='LIF'; Plasticity='HomeostaticGain'; Just='Cholinergic transients and attention gating are modeled as burst-capable modulatory LIF outputs.'; FeedbackMin=0; FeedbackMax=0},
